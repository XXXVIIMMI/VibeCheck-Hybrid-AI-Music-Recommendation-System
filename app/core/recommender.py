...
"""
Define paths relative to this file (app/core/recommender.py)
../../data
"""
base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
data_dir = os.path.join(base_dir, 'data')

df_path = os.path.join(data_dir, 'df_cleaned.pkl')
cosine_sim_path = os.path.join(data_dir, 'cosine_sim.pkl')
